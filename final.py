...
section = st.sidebar.radio("Select Section", ["Correlation Analysis", "Visualizations"])
...
if section == "Correlation Analysis":
    ...
    colors = ['#FF9999', '#FFB366', '#FFFF66', '#B3FF66', '#66FF66']
    ...
    plt.tight_layout()
    st.pyplot(fig)
    st.write("This final bar chart looks at how often different genders and ages are using social media to compare themselves to other. As can be seen, younger ages are much more frequently comparing themselves to more successful people online.")
